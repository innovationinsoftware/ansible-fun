...
This site includes the labs for the Ansible Automation Fundamentals class.

## Labs

[VM Information](VM_access_Group-A.md)   
[Ansible Controller Information](https://docs.google.com/spreadsheets/d/1P_rrijRUZVtwRfS5rKJaWUP1_mIjg5QozRDyFj0eqMQ/edit?usp=sharing)

### Day 1
Lab 1: [Connect to Ansible Controller](labs/setup/index.md)   
Lab 2: [Ansible inventory](labs/inventory/index.md)   
Lab 3: [Ansible ad-hoc](labs/ad-hoc/index.md)   
Lab 4: [Ansible playbook fundamentals](labs/playbook-fun/index.md)   

### Day 2
Lab 5: [Ansible Playbook Error Handling](labs/error-handling/index.md)   
